...
class PlayControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    ...
    assert_difference "Play.count", +1 do
      post :create, play: { game_id: games(:one), user_id: users(:one), character_name: "some name" }
    end
  ...
  test "shouldn't create play as random user" do
    ...
    assert_no_difference "Play.count" do
      post :create, play: { game_id: games(:one), user_id: users(:three), character_name: "some name" }
    end
