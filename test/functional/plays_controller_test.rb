...
class PlaysControllerTest < ActionController::TestCase
  ...
  test "should create play" do
    ...
    assert_difference "Play.count", +1 do
      post :create, play: { game_id: games(:one), user_id: users(:one), character_id: characters(:one) }, game_id: @play.game
    end
  ...
  test "shouldn't create play as random user" do
    ...
    assert_no_difference "Play.count" do
      post :create, play: { game_id: games(:one), user_id: users(:three), character_id: characters(:one) }, game_id: games(:one)
    end
  ...
  test "should update play as gm" do
    ...
    put :update, id: @play, play: { character_id: characters(:two) }, game_id: @play.game
